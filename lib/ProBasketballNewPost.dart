...
class ProBasketballNewPost extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return ProBasketballNewPostState();
  }

}

class ProBasketballNewPostState extends State<ProBasketballNewPost>{
  TextEditingController titleController;
  TextEditingController authorController;
  TextEditingController blogBodyController;

  makePostRequest() async {
    String url = 'http://157.245.138.14:4444/probasketballnewpost';
